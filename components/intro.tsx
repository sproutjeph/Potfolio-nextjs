  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          className="flex items-center gap-2 py-3 transition bg-white rounded-md outline-none cursor-pointer group px-7 focus:scale-110 hover:scale-110 active:scale-105 borderBlack dark:bg-white/10"
          href="/CV.pdf"
          download
        >
          Download CV{" "}
        ...
        <a
          ...
          href="https://www.linkedin.com/in/jephthah-mbah-jw-71244263/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
